...
public class HashMap<K,V> extends AbstractMap<K,V>
   ...
   * shrinkage.
   * 链表转红黑树的门槛 - 链表中节点的个数到达 8 个的时候转为红黑树
   */
   ...
   * 链表节点 - 报错键值对的数据结构，包含key 的 hash 值，key，value以及下一个节点
   */
   ...
   * 计算 key 哈希值的 hash 算法，注意留意除了调用 key的 hashcode 方法以外，还额外与 hashcode
   * 值的高 16 位异或，目的是为了使得 hash 值更加分散减少 hash碰撞的可能性
   */
